...
class CommandGroup {
	...
	setEnabledIn(guild, enabled) {
		if(typeof guild === 'undefined') throw new TypeError('guild não pode estar indefinida.');
		if(typeof enabled === 'undefined') throw new TypeError('Enable não pode estar indefinido.');
